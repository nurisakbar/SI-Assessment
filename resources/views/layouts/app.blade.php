    ...
    <body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
                    ...
                    <li class="nav-item dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <div class="user-nav d-sm-flex d-none">
                                ...
                                <span class="user-status">{{ Auth::user()->pekerjaan }}</span>
                            </div>
                            <span class="avatar">
                ...
                <ul class="nav navbar-nav flex-row">
                    <li class="nav-item me-auto">
                        <a class="navbar-brand" href="../../../html/ltr/vertical-menu-template/index.html">
                            ...
                            <h2 class="brand-text">MY ASSESMENT</h2>
                        </a>
                    </li>
            ...
            <div class="main-menu-content">
                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                        ...
                        <ul class="menu-content {!! (Request::is('pertanyaan*') || Request::is('user*')) ? 'show' : '' !!}">
                            <li class="{!!(Request::is('pertanyaan*')) ? ' active' : '' !!}">
                                <a class="d-flex align-items-center" href="{{ route('pertanyaan.index') }}">
                                    ...
                                    <span class="menu-item text-truncate" data-i18n="List">Pertanyaan</span>
                                </a>
                            </li>
                            <li class="{!!(Request::is('user*')) ? ' active' : '' !!}">
                                <a class="d-flex align-items-center" href="{{ route('user.index') }}">
                                    <i data-feather="circle"></i>
                                    <span class="menu-item text-truncate" data-i18n="List">User</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item {!!(Request::is('report')) ? ' active' : '' !!}">
                        <a class="d-flex align-items-center" href="{{ route('report.index') }}">
                            <i data-feather='file-text'></i>
                            <span class="menu-title text-truncate" data-i18n="Modal Examples">Report Jawaban</span>
                        </a>
                    </li>
                    @endif
                </ul>
        ...
        <footer class="footer footer-static footer-light">
            <p class="clearfix mb-0">
                <span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT &copy; {{ date('Y') }} <a class="ms-25" href="https://psikologisred7f.com/" target="_blank">MY ASSESMENT</a>
